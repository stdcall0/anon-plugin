...
export class QuotesPlugin extends Plugin {
    ...
    async upload() {
        var _a;
        if (!this.e.isGroup || !this.e.group_id || !this.e.user_id)
            return;
        ...
        if (this.e.img) {
            ...
            let source = (_a = (await this.e.getReply())) === null || _a === void 0 ? void 0 : _a.message;
        ...
        const max_img_size = Config.get('quotes').get('max_img_size') || 5;
    ...
    async info() {
        ...
        const card = (_b = (_a = this.e.group) === null || _a === void 0 ? void 0 : _a.pickMember(quote.uploaderId)) === null || _b === void 0 ? void 0 : _b.card;
